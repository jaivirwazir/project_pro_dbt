...
def create_connection():
   conn = snow.connect(user="JAIVIRWAZIR",
   password="Work1aig!",
   account="dx48665.us-east-2.aws",
...
def load_data():
   cur,conn=create_connection()
   titles_file = r"/Users/jaivirwazir/projects/dbt-snowflake/datasets/titles.csv" # <- Replace with your path.
   titles_delimiter = "," # Replace if you're using a different delimiter.
   credits_file=r"/Users/jaivirwazir/projects/dbt-snowflake/datasets/credits.csv"
   credits_delimiter=","
